...
import { deleteActor } from "../../services/actors";

export function useDeletePlace(onSuccess, onMutationStart, onMutationEnd) {
  const queryClient = useQueryClient();

  const deleteActorMutation = useAuthMutation(deleteActor, {
    onMutate: async () => {
