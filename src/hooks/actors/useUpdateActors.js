...
import { deleteActor, editActor } from "../../services/actors";

export function useUpdateActor(onSuccess, onMutationStart, onMutationEnd) {
  const queryClient = useQueryClient();

  const updateActorMutation = useAuthMutation(editActor, {
    onMutate: async () => {
